...
function afficheFilmParGenre() {
    var x = document.getElementById("mySelect").value;

    

    $.get("  https://api.themoviedb.org/3/discover/movie?api_key=93536a4648a2f2ab923edc1f9f063b20&with_genres="+x,afficherParGenre);
